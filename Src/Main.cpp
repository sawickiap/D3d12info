...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS(const D3D12_FEATURE_DATA_D3D12_OPTIONS& options)
{
    ...
    formatter.AddFieldEnum(L"MinPrecisionSupport", options.MinPrecisionSupport,
                           Enum_D3D12_SHADER_MIN_PRECISION_SUPPORT);
...
static void Print_D3D12_FEATURE_DATA_FEATURE_LEVELS(const D3D12_FEATURE_DATA_FEATURE_LEVELS& featureLevels)
{
    ...
    ReportFormatter::GetInstance().AddFieldEnum(L"MaxSupportedFeatureLevel", featureLevels.MaxSupportedFeatureLevel,
                                                Enum_D3D_FEATURE_LEVEL);
}
    ...
    const D3D12_FEATURE_DATA_GPU_VIRTUAL_ADDRESS_SUPPORT& virtualAddressSupport)
{
    ...
    ReportFormatter::GetInstance().AddFieldUint32(L"MaxGPUVirtualAddressBitsPerResource",
                                                  virtualAddressSupport.MaxGPUVirtualAddressBitsPerResource);
    ReportFormatter::GetInstance().AddFieldUint32(L"MaxGPUVirtualAddressBitsPerProcess",
                                                  virtualAddressSupport.MaxGPUVirtualAddressBitsPerProcess);
}
...
static void Print_D3D12_FEATURE_DATA_SHADER_MODEL(const D3D12_FEATURE_DATA_SHADER_MODEL& shaderModel)
{
    ...
    ReportFormatter::GetInstance().AddFieldEnum(L"HighestShaderModel", shaderModel.HighestShaderModel,
                                                Enum_D3D_SHADER_MODEL);
}
...
static void Print_D3D12_FEATURE_DATA_ROOT_SIGNATURE(const D3D12_FEATURE_DATA_ROOT_SIGNATURE& rootSignature)
{
    ...
    ReportFormatter::GetInstance().AddFieldEnum(L"HighestVersion", rootSignature.HighestVersion,
                                                Enum_D3D_ROOT_SIGNATURE_VERSION);
}
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS2(const D3D12_FEATURE_DATA_D3D12_OPTIONS2& options2)
{
    ...
    ReportFormatter::GetInstance().AddFieldEnum(L"ProgrammableSamplePositionsTier",
                                                ...
                                                Enum_D3D12_PROGRAMMABLE_SAMPLE_POSITIONS_TIER);
}
...
static void Print_D3D12_FEATURE_DATA_SHADER_CACHE(const D3D12_FEATURE_DATA_SHADER_CACHE& shaderCache)
{
    ...
    ReportFormatter::GetInstance().AddFieldFlags(L"SupportFlags", shaderCache.SupportFlags,
                                                 Enum_D3D12_SHADER_CACHE_SUPPORT_FLAGS);
}
...
static void Print_D3D12_FEATURE_DATA_COMMAND_QUEUE_PRIORITY(const std::array<bool, 9>& commandQueuePriority)
{
    ...
    formatter.AddFieldBool(L"TYPE_COMPUTE.PRIORITY_GLOBAL_REALTIME.PriorityForTypeIsSupported",
                           commandQueuePriority[5]);
...
static void Print_D3D12_FEATURE_DATA_SERIALIZATION(const D3D12_FEATURE_DATA_SERIALIZATION& serialization)
{
    ...
    ReportFormatter::GetInstance().AddFieldEnum(L"HeapSerializationTier", serialization.HeapSerializationTier,
                                                Enum_D3D12_HEAP_SERIALIZATION_TIER);
}
...
static void Print_D3D12_FEATURE_CROSS_NODE(const D3D12_FEATURE_DATA_CROSS_NODE& crossNode)
{
    ...
    ReportFormatter::GetInstance().AddFieldEnum(L"SharingTier", crossNode.SharingTier,
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS6(const D3D12_FEATURE_DATA_D3D12_OPTIONS6& o)
{
    ...
    formatter.AddFieldEnum(L"VariableShadingRateTier", o.VariableShadingRateTier,
                           Enum_D3D12_VARIABLE_SHADING_RATE_TIER);
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS7(const D3D12_FEATURE_DATA_D3D12_OPTIONS7& o)
{
    ...
    ReportFormatter::GetInstance().AddFieldEnum(L"SamplerFeedbackTier", o.SamplerFeedbackTier,
                                                Enum_D3D12_SAMPLER_FEEDBACK_TIER);
}
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS9(const D3D12_FEATURE_DATA_D3D12_OPTIONS9& o)
{
    ...
    formatter.AddFieldBool(L"MeshShaderSupportsFullRangeRenderTargetArrayIndex",
    ...
    formatter.AddFieldBool(L"DerivativesInMeshAndAmplificationShadersSupported",
                           o.DerivativesInMeshAndAmplificationShadersSupported);
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS10(const D3D12_FEATURE_DATA_D3D12_OPTIONS10& o)
{
    ...
    ReportFormatter::GetInstance().AddFieldBool(L"VariableRateShadingSumCombinerSupported",
                                                o.VariableRateShadingSumCombinerSupported);
    ReportFormatter::GetInstance().AddFieldBool(L"MeshShaderPerPrimitiveShadingRateSupported",
                                                o.MeshShaderPerPrimitiveShadingRateSupported);
}
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS11(const D3D12_FEATURE_DATA_D3D12_OPTIONS11& o)
{
    ...
    ReportFormatter::GetInstance().AddFieldBool(L"AtomicInt64OnDescriptorHeapResourceSupported",
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS13(const D3D12_FEATURE_DATA_D3D12_OPTIONS13& o)
{
    ...
    formatter.AddFieldBool(L"UnrestrictedBufferTextureCopyPitchSupported",
                           o.UnrestrictedBufferTextureCopyPitchSupported);
    formatter.AddFieldBool(L"UnrestrictedVertexElementAlignmentSupported",
                           o.UnrestrictedVertexElementAlignmentSupported);
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS14(const D3D12_FEATURE_DATA_D3D12_OPTIONS14& o)
{
    ...
    formatter.AddFieldBool(L"IndependentFrontAndBackStencilRefMaskSupported",
                           o.IndependentFrontAndBackStencilRefMaskSupported);
}
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS15(const D3D12_FEATURE_DATA_D3D12_OPTIONS15& o)
{
    ...
    ReportFormatter::GetInstance().AddFieldBool(L"DynamicIndexBufferStripCutSupported",
                                                o.DynamicIndexBufferStripCutSupported);
}
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS17(const D3D12_FEATURE_DATA_D3D12_OPTIONS17& o)
{
    ...
    ReportFormatter::GetInstance().AddFieldBool(L"NonNormalizedCoordinateSamplersSupported",
                                                o.NonNormalizedCoordinateSamplersSupported);
    ReportFormatter::GetInstance().AddFieldBool(L"ManualWriteTrackingResourceSupported",
...
static void Print_D3D12_FEATURE_DATA_D3D12_OPTIONS19(const D3D12_FEATURE_DATA_D3D12_OPTIONS19& o)
{
    ...
    formatter.AddFieldUint32(L"MaxSamplerDescriptorHeapSizeWithStaticSamplers",
                             o.MaxSamplerDescriptorHeapSizeWithStaticSamplers);
...
static void PrintOsVersionInfo()
{
    ...
    formatter.AddFieldString(L"Windows version",
                             std::format(L"{}.{}.{}", osVersionInfo.dwMajorVersion, osVersionInfo.dwMinorVersion,
...
static void PrintSystemMemoryInfo()
{
    ...
    if (uint64_t physicallyInstalledSystemMemory = 0;
        ...
        ReportFormatter::GetInstance().AddFieldSizeKilobytes(L"GetPhysicallyInstalledSystemMemory",
...
static void EnableExperimentalFeatures()
{
    ...
    while (featureBitMask != 0)
    {
        ...
        if (SUCCEEDED(g_D3D12EnableExperimentalFeatures(featuresToEnableCount, featuresToEnable, configStructs,
                                                        configStructSizes)))
            break;
        --featureBitMask;
    }
...
static void PrintAdapterDesc2Members(const DXGI_ADAPTER_DESC2& desc2)
{
    ...
    ReportFormatter::GetInstance().AddFieldEnum(L"ComputePreemptionGranularity", desc2.ComputePreemptionGranularity,
                                                Enum_DXGI_COMPUTE_PREEMPTION_GRANULARITY);
}
...
static void PrintFormatInformation(ID3D12Device* device)
{
    ...
    for (size_t formatIndex = 0; Enum_DXGI_FORMAT[formatIndex].m_Name != nullptr; ++formatIndex)
    {
        ...
        if (formatSupportResult == FormatSupportResult::Ok)
        {
            ...
            {
                if (SUCCEEDED(device->CheckFeatureSupport(D3D12_FEATURE_MULTISAMPLE_QUALITY_LEVELS, &msQualityLevels,
                                                          UINT(sizeof msQualityLevels))) &&
                    ...
                    else
                    {
                        ...
                        formatter.AddFieldString(
                            ...
                            std::format(L"{}: NumQualityLevels = {}{}", msQualityLevels.SampleCount,
                                        ...
                                        multisampleTiled ? L"  D3D12_MULTISAMPLE_QUALITY_LEVELS_FLAG_TILED_RESOURCE"
                                                         : L""));
                    }
                }
                else
...
static void PrintMetaCommand(ID3D12Device5* device5, UINT index, const D3D12_META_COMMAND_DESC& desc)
{
    ...
    for (UINT stageIndex = 0; stageIndex < 3; ++stageIndex)
    {
        ...
        UINT paramCount = 0;
        HRESULT hr = device5->EnumerateMetaCommandParameters(desc.Id, (D3D12_META_COMMAND_PARAMETER_STAGE)stageIndex,
        ...
        if (paramCount > 0)
        {
            ...
            hr = device5->EnumerateMetaCommandParameters(desc.Id, (D3D12_META_COMMAND_PARAMETER_STAGE)stageIndex,
            ...
            if (SUCCEEDED(hr))
            {
                ...
                for (UINT paramIndex = 0; paramIndex < paramCount; ++paramIndex)
                {
                    ...
                    formatter.AddFieldFlags(L"RequiredResourceState", paramDesc.RequiredResourceState,
                                            Enum_D3D12_RESOURCE_STATES);
...
static void PrintCommandQueuePriorities(ID3D12Device* device)
{
    ...
    for (auto cmdListType : cmdListTypes)
    {
        for (auto cmdQueuePriority : cmdQueuePriorities)
        {
            ...
            if (FAILED(device->CheckFeatureSupport(D3D12_FEATURE_COMMAND_QUEUE_PRIORITY, &commandQueuePriority,
                                                   sizeof(commandQueuePriority))))
                return;
...
static void PrintDirectSROptimizationRankings(const DSR_OPTIMIZATION_TYPE* optimizationRankings)
{
    ...
    ReportFormatter::GetInstance().AddEnumArray(L"OptimizationRankings", rankingsCopy, count,
...
static int PrintDeviceDetails(IDXGIAdapter1* adapter1, NvAPI_Inititalize_RAII* nvAPI, AGS_Initialize_RAII* ags)
{
    ...
    if (D3D12_FEATURE_DATA_GPU_VIRTUAL_ADDRESS_SUPPORT gpuVirtualAddressSupport = {};
        SUCCEEDED(device->CheckFeatureSupport(D3D12_FEATURE_GPU_VIRTUAL_ADDRESS_SUPPORT, &gpuVirtualAddressSupport,
                                              sizeof(gpuVirtualAddressSupport))))
    ...
    */
    ...
    if (D3D12_FEATURE_DATA_APPLICATION_SPECIFIC_DRIVER_STATE appSpecificDriverState = {};
        SUCCEEDED(device->CheckFeatureSupport(D3D12_FEATURE_APPLICATION_SPECIFIC_DRIVER_STATE, &appSpecificDriverState,
                                              sizeof(appSpecificDriverState))))
...
static void ListAdapter(uint32_t adapterIndex, IDXGIAdapter* adapter, NvAPI_Inititalize_RAII* nvApi,
                        AGS_Initialize_RAII* ags, AmdDeviceInfo_Initialize_RAII* amdDeviceInfo,
                        Vulkan_Initialize_RAII* vk)
{
    ...
    if (SUCCEEDED(adapter->GetDesc(&desc)))
    {
        ...
        if (useAGS && ags && ags->IsInitialized())
        {
            AGS_Initialize_RAII::DeviceId deviceId = { .vendorId = (int)desc.VendorId,
...
int wmain3(int argc, wchar_t** argv)
{
    ...
    // Scope for COM objects.
    {
        ...
        ReportScopeArrayConditional scopeArray(g_PrintAdaptersAsArray, SelectString(L"Adapter", L"Adapters"),
                                               ReportFormatter::ARRAY_SUFFIX_NONE);
        ReportScopeObjectConditional scopeObject(!g_PrintAdaptersAsArray, L"Adapter");

        if (g_ListAdapters)
            ListAdapters(dxgiFactory.Get(), nvApiObjPtr.get(), agsObjPtr.get(), amdDeviceInfoObjPtr.get(),
                         vkObjPtr.get());
        else
        {
            if (g_WARP)
                ...
                InspectAllAdapters(dxgiFactory.Get(), nvApiObjPtr.get(), agsObjPtr.get(), amdDeviceInfoObjPtr.get(),
                                   vkObjPtr.get());
        }
    }
