...
ENUM_BEGIN(D3D12_WORK_GRAPHS_TIER)
	...
	ENUM_ITEM(D3D12_WORK_GRAPHS_TIER_0_1)
ENUM_END(D3D12_WORK_GRAPHS_TIER)

ENUM_BEGIN(D3D12_WAVE_MMA_INPUT_DATATYPE)
	ENUM_ITEM(D3D12_WAVE_MMA_INPUT_DATATYPE_INVALID)
	ENUM_ITEM(D3D12_WAVE_MMA_INPUT_DATATYPE_BYTE)
	ENUM_ITEM(D3D12_WAVE_MMA_INPUT_DATATYPE_FLOAT16)
	ENUM_ITEM(D3D12_WAVE_MMA_INPUT_DATATYPE_FLOAT)
ENUM_END(D3D12_WAVE_MMA_INPUT_DATATYPE)

ENUM_BEGIN(D3D12_WAVE_MMA_DIMENSION)
	ENUM_ITEM(D3D12_WAVE_MMA_DIMENSION_INVALID)
	ENUM_ITEM(D3D12_WAVE_MMA_DIMENSION_16)
	ENUM_ITEM(D3D12_WAVE_MMA_DIMENSION_64)
ENUM_END(D3D12_WAVE_MMA_DIMENSION)

ENUM_BEGIN(D3D12_WAVE_MMA_ACCUM_DATATYPE)
	ENUM_ITEM(D3D12_WAVE_MMA_ACCUM_DATATYPE_NONE)
	ENUM_ITEM(D3D12_WAVE_MMA_ACCUM_DATATYPE_INT32)
	ENUM_ITEM(D3D12_WAVE_MMA_ACCUM_DATATYPE_FLOAT16)
	ENUM_ITEM(D3D12_WAVE_MMA_ACCUM_DATATYPE_FLOAT)
ENUM_END(D3D12_WAVE_MMA_ACCUM_DATATYPE)
