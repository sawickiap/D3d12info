...
ENUM_BEGIN(D3D12_MLIR_PROGRAMS_TIER)
    ENUM_ITEM(D3D12_MLIR_PROGRAMS_TIER_NOT_SUPPORTED)
    ENUM_ITEM(D3D12_MLIR_PROGRAMS_TIER_1_0)
    ENUM_ITEM(D3D12_MLIR_PROGRAMS_TIER_2_0)
ENUM_END(D3D12_MLIR_PROGRAMS_TIER)
