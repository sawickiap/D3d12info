...
ENUM_BEGIN(D3D12_COOPERATIVE_VECTOR_TIER)
    ENUM_ITEM(D3D12_COOPERATIVE_VECTOR_TIER_NOT_SUPPORTED)
    ENUM_ITEM(D3D12_COOPERATIVE_VECTOR_TIER_1_0)
    ENUM_ITEM(D3D12_COOPERATIVE_VECTOR_TIER_1_1)
ENUM_END(D3D12_COOPERATIVE_VECTOR_TIER)
...
ENUM_BEGIN(D3D12_LINEAR_ALGEBRA_DATATYPE)
    ...
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_SINT8_T4_PACKED)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_UINT8_T4_PACKED)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_UINT8)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_SINT8)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_FLOAT_E4M3)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_FLOAT_E5M2)
